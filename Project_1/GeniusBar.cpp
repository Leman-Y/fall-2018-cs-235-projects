...
Description: Implement functions for class GeniusBar
*/
...
bool GeniusBar::updateCustomersWaitTime()
{
	...
	{
		for(int index =0; index < number_of_customers_ ; index++){

			genius_bar_[index].updateWaitTime(genius_bar_[index].getWaitTime() + WAIT_TIME_INCREMENT);
